...
$file = new SplFileObject("../CSV/districts.csv");
...
$access->query('TRUNCATE TABLE districts');

$query = $access->prepare('INSERT INTO districts (id, region_id, region_name, city_id, city_name, name, pemilih, pengguna_hak_pilih, perolehan_suara, suara_sah, suara_tidak_sah, total_suara, link, resource)
               VALUES (:id, :region_id, :region_name, :city_id, :city_name, :name, :pemilih, :pengguna_hak_pilih, :perolehan_suara, :suara_sah, :suara_tidak_sah, :total_suara, :link, :resource)
